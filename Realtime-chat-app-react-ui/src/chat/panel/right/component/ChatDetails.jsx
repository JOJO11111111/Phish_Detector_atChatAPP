...
class ChatDetails extends React.Component {
    ...
    /**
     * After sending a message or accepting the message, roll to the end
     */
    scrollToBottom = () => {
    ...
    /**
     * Get group chat information, group members list
     */
    chatDetails = () => {
    ...
    render() {
        ...
        return (
            <>
                ...
                <Drawer title="Member list" placement="right" onClose={this.drawerOnClose} visible={this.state.drawerVisible}>
                    <List
                        itemLayout="horizontal"
