...
# --- ADD TO THE BOTTOM OF eval.py ---
# def detect_ai_voice(audio_path, model_path, config_path='model_config_RawNet.yaml', device=None):
#     import torch
#     import numpy as np
#     import yaml
#     from model import RawNet
...
#     out_list_binary = []
#     for m_batch in load_sample(audio_path):
#         m_batch = m_batch.to(device=device, dtype=torch.float).unsqueeze(0)
...
#     result_binary = np.average(out_list_binary, axis=0).tolist()
#     return {
#         'ai_fake_score': float(result_binary[0]),
#         'ai_real_score': float(result_binary[1])
#     }
...
# detect_ai_voice = detect_ai_voice("/home/tiffanybao/PhishIntention/datasets/test_sites/mom_fixed.wav", "/home/tiffanybao/PhishIntention/models/librifake_pretrained_lambda0.5_epoch_25.pth", "model_config_RawNet.yaml")
# print(detect_ai_voice)
